      ...
      <div className="lg:col-span-7 dark:bg-[#070916] bg-white dark:border-white/10 border-slate-200 rounded-3xl p-5 shadow-2xl backdrop-blur-xl flex flex-col">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-5 items-center dark:bg-black/30 bg-slate-100/30 p-4 rounded-2xl border dark:border-white/5 border-slate-200">
          ...
          <div className="md:col-span-5 flex flex-col items-center justify-center min-h-[350px] relative">
            ...
            {/* Labels */}
            <div className="text-center mt-3 text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400">
      ...
      <div className="lg:col-span-5 space-y-4">
        ...
        <div className="p-6 rounded-3xl bg-white dark:bg-slate-900 border dark:border-white/10 border-slate-200 shadow-2xl space-y-5">
          <div className="border-b dark:border-white/10 border-slate-200 pb-3">
            <h3 className="text-sm font-black text-slate-900 dark:text-white uppercase tracking-wide">Chemical Parameters</h3>
          </div>

          {/* Titration Mode */}
          <div className="space-y-2.5">
            <span className="text-xs font-bold text-slate-700 dark:text-slate-300 block">Titration Setup:</span>
          ...
          {/* Indicator Selection */}
          <div className="space-y-2.5">
            <span className="text-xs font-bold text-slate-700 dark:text-slate-300 block">Chemical Indicator:</span>
          ...
          <div className="space-y-3 pt-3 border-t dark:border-white/10 border-slate-200">
            <span className="text-xs font-bold text-slate-700 dark:text-slate-300 block">Valve Flow Control:</span>
            
            <div className="grid grid-cols-2 gap-2">
              <button
                onClick={() => addDrip(0.1)}
                disabled={volumeAdded >= 50.0 || isFlowing}
                className="py-2.5 rounded-xl border dark:border-white/10 border-slate-200 dark:hover:bg-white/5 hover:bg-slate-100 text-xs font-black uppercase tracking-wider transition-all text-slate-900 dark:text-white disabled:opacity-40"
              >
                +0.1 mL (Drop)
              </button>
              <button
