...
export default function NotFound() {
  return (
    <div className="min-h-screen flex items-center justify-center dark:bg-[#06080f] bg-[#eef1f9] dark:text-white text-slate-900 p-6 text-center">
      <div className="max-w-md w-full dark:bg-[#080b18] bg-[#eef1f9] border border-white/10 rounded-3xl p-8 shadow-2xl backdrop-blur-xl">
        ...
        <h2 className="text-xl font-bold dark:text-slate-200 text-slate-800 mb-3">Page Not Found</h2>
