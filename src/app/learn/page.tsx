...
export default function LearnHub() {
  ...
  return (
    ...
    >
      <motion.header variants={item} className="relative p-8 rounded-[2rem] overflow-hidden bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm">
          ...
          >
            {group.subjects.map((subject) => {
              ...
              if (subject.name === "English") {
                return (
                  <motion.div variants={item} key={subject.name} className="col-span-1 sm:col-span-2 lg:col-span-2 bg-white dark:bg-slate-800/80 backdrop-blur-xl p-8 rounded-[2rem] shadow-lg shadow-slate-200/50 dark:shadow-none border border-slate-200 dark:border-slate-700/50 hover:shadow-xl transition-all duration-300">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      <Link href="/learn/english-communicative" className="flex items-center gap-4 p-5 rounded-2xl bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 hover:border-purple-400 dark:hover:border-purple-500 hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-all duration-300 hover:-translate-y-1 hover:shadow-md group">
                        ...
                        <div>
                          <p className="font-bold text-slate-800 dark:text-slate-200 group-hover:text-purple-600 dark:group-hover:text-purple-400 text-purple-700 transition-colors">Communicative</p>
                          <p className="text-sm font-medium text-slate-500 dark:text-slate-400 mt-0.5">14 Chapters</p>
                        </div>
                      </Link>

                      <Link href="/learn/english-literature" className="flex items-center gap-4 p-5 rounded-2xl bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 hover:border-fuchsia-400 dark:hover:border-fuchsia-500 hover:bg-fuchsia-50 dark:hover:bg-fuchsia-900/20 transition-all duration-300 hover:-translate-y-1 hover:shadow-md group">
                        ...
                        <div>
                          <p className="font-bold text-slate-800 dark:text-slate-200 group-hover:text-fuchsia-600 dark:group-hover:text-fuchsia-400 text-fuchsia-700 transition-colors">Lang & Lit</p>
              ...
              return (
                <motion.div variants={item} key={subject.name} className="h-full">
                  <Link href={`/learn/${subject.name.toLowerCase().replace(/ & /g, '-').replace(/ /g, '-')}`} className="group block h-full">
                    <div className="bg-white dark:bg-slate-800/80 backdrop-blur-xl p-8 rounded-[2rem] shadow-lg shadow-slate-200/50 dark:shadow-none border border-slate-200 dark:border-slate-700/50 hover:border-indigo-300 dark:hover:border-indigo-500/50 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl h-full flex flex-col relative overflow-hidden">
                      ...
                      <div className="mt-auto bg-slate-50 dark:bg-slate-900/50 p-4 rounded-2xl border border-slate-100 dark:border-slate-800">
