                  ...
                  <div className="mt-2 pt-4 border-t border-slate-100 dark:border-slate-800/80 w-full">
                    {hasDecks ? (
                            ...
                            {decks.map(deck => {
                              ...
                              return (
                                <Link href={deck.link} key={deck.id} className="block group">
                                  <div className="relative bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl overflow-hidden p-6 flex flex-col gap-4 hover:border-slate-300 dark:hover:border-slate-700 hover:shadow-xl hover:-translate-y-0.5 transition-all text-slate-900 dark:text-white">
                                    {/* Color accent top bar */}
                                    <div className={`absolute top-0 inset-x-0 h-1.5 bg-gradient-to-r ${gradient}`} />

                                    <div className="flex items-center justify-between">
                                      <span className="inline-block px-3 py-1 bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 border border-emerald-500/30 text-xs font-bold rounded-full">
                                        {deck.subject}
                                      </span>
                                      ...
                                      <div className="flex items-center gap-2">
                                        ...
                                        <button
                                          ...
                                          className="p-1.5 bg-slate-100 dark:bg-slate-800 hover:bg-red-500/25 hover:text-red-500 border border-slate-250 dark:border-slate-750 rounded-xl transition-all text-slate-400 z-10"
                                          title="Delete Deck"
                                        >
                                        ...
                                        <span className="inline-block px-2 py-0.5 bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 border border-emerald-500/30 text-xs font-bold rounded-full flex items-center gap-1">
                                          <Flame className="w-3.5 h-3.5 text-emerald-600 dark:text-emerald-400" /> Studied
                                        </span>
                                      </div>
                                    </div>
                      ...
                      <div className="flex items-center justify-between text-sm py-1 bg-slate-50 dark:bg-slate-900/10 bg-slate-200/10 px-3 rounded-xl border border-slate-100 dark:border-slate-800">
                        <p className="text-slate-600 dark:text-slate-400 font-medium text-xs">No flashcards generated yet.</p>
                        <button
