              ...
              {activeTab === "focus" && (
                ...
                >
                  ...
                  <div className="grid lg:grid-cols-3 gap-6">
                    ...
                    {/* Left Column: Today's Question + Smart Whiteboard Canvas */}
                    <div className="lg:col-span-2 space-y-6">
                      <motion.div variants={item} id="tour-daily-challenge">
                        <DailyQuestionWidget />
                      </motion.div>

                      {/* Interactive AI Whiteboard Bento Card */}
                      <motion.div variants={item} className="premium-glass-panel p-6 rounded-3xl border border-pink-500/20 hover:border-pink-500/40 transition-all relative overflow-hidden group shadow-sm">
                        <div className="absolute top-0 right-0 w-48 h-48 bg-gradient-to-bl from-pink-500/10 via-purple-500/5 to-transparent blur-2xl rounded-full pointer-events-none" />
                        
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4 relative z-10">
                          <div className="flex items-center gap-3.5">
                            <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-pink-500 to-purple-600 flex items-center justify-center text-white shadow-lg shadow-pink-500/25 group-hover:scale-105 transition-transform shrink-0">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-slate-600 dark:text-slate-400 mt-0.5 font-medium">
                                Sketch diagrams, solve handwritten CBSE equations, and generate LaTeX steps.
                              </p>
                            </div>
                          </div>
                          ...
                          <Link
                            href="/whiteboard"
                            className="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-2xl bg-gradient-to-r from-pink-600 to-purple-600 hover:opacity-95 text-white font-extrabold text-xs shadow-md shadow-pink-500/20 active:scale-95 transition-all shrink-0 cursor-pointer"
                          >
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 relative z-10 pt-1">
                          <Link href="/whiteboard" className="p-2.5 rounded-xl bg-slate-50 dark:bg-white/5 border border-slate-200/80 dark:border-white/10 hover:border-pink-500/30 flex items-center gap-2 transition-all group/sub">
                            <span className="text-base">✍️</span>
                            <span className="text-xs font-bold text-slate-700 dark:text-slate-300 group-hover/sub:text-pink-600 dark:group-hover/sub:text-pink-400">Handwriting AI</span>
                          </Link>
                          <Link href="/whiteboard" className="p-2.5 rounded-xl bg-slate-50 dark:bg-white/5 border border-slate-200/80 dark:border-white/10 hover:border-purple-500/30 flex items-center gap-2 transition-all group/sub">
                            <span className="text-base">📐</span>
                            <span className="text-xs font-bold text-slate-700 dark:text-slate-300 group-hover/sub:text-purple-600 dark:group-hover/sub:text-purple-400">Smart Shapes</span>
                          </Link>
                          <Link href="/whiteboard" className="p-2.5 rounded-xl bg-slate-50 dark:bg-white/5 border border-slate-200/80 dark:border-white/10 hover:border-indigo-500/30 flex items-center gap-2 transition-all group/sub">
                            <span className="text-base">∑</span>
                            <span className="text-xs font-bold text-slate-700 dark:text-slate-300 group-hover/sub:text-indigo-600 dark:group-hover/sub:text-indigo-400">KaTeX Solver</span>
                          </Link>
                          <Link href="/whiteboard" className="p-2.5 rounded-xl bg-slate-50 dark:bg-white/5 border border-slate-200/80 dark:border-white/10 hover:border-emerald-500/30 flex items-center gap-2 transition-all group/sub">
                            <span className="text-base">📄</span>
                            <span className="text-xs font-bold text-slate-700 dark:text-slate-300 group-hover/sub:text-emerald-600 dark:group-hover/sub:text-emerald-400">Export PDF</span>
                          </Link>
                        </div>
                      </motion.div>
                    </div>
