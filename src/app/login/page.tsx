...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row items-center justify-center p-6 relative overflow-x-hidden transition-colors duration-300" style={{ backgroundColor: "var(--background)" }}>
        ...
        >
          ...
          <div className="space-y-5">
            ...
            <motion.div variants={itemVariants} className="flex items-center gap-4 py-1.5">
              ...
              <span className="text-[10px] dark:text-slate-400 text-slate-600 dark:text-slate-500 font-black tracking-widest uppercase">Or email</span>
              <div className="flex-1 h-px bg-slate-200/70 dark:bg-white/5" />
            </motion.div>
